...
<div class="main-area">
    <h2>Справка за дипломирани студенти с даден рецензент</h2></br>
...
<script>
    $(function(){
        ...
        $("#search").click(function(){
            window.location = "${pageContext.request.contextPath}/statistic/committee?startDate="+$("#from_date").val()+"&endDate="+$("#to_date").val()+"&date="+$("#date_date").val()+"&type="+$("#type_select").val();
        });
    });
</script>
